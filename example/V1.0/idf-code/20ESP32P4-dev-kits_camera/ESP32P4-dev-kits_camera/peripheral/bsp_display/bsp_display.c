...
static esp_err_t display_port_init(void)
{
    ...
    const esp_lcd_dpi_panel_config_t dpi_config = {
        ...
        .num_fbs = 2,                                /*Number of screen-sized frame buffers that allocated by the drivered */
        .video_timing = {
...
static esp_err_t lvgl_init()
{
    ...
    const lvgl_port_display_cfg_t disp_cfg = {
        ...
        .buffer_size = H_size * V_size, /*Size of the buffer for the screen in pixels*/
        .double_buffer = false,                                         /*True, if should be allocated two buffers*/
        ...
        .flags = {
            ...
            .sw_rotate = false,   /* Use software rotation (slower) or PPA if available*/
#if LVGL_VERSION_MAJOR >= 9
