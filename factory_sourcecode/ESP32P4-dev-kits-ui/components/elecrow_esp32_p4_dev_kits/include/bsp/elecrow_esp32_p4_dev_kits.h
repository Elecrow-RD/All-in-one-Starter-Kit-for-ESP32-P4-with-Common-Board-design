...
#include "sdkconfig.h"
#include "../../elecrow_ui/include/elecrow_ui.h"
...
#define BSP_LCD_TOUCH_INT (GPIO_NUM_41)
#define BSP_LCD_UPDN (GPIO_NUM_32)
#define BSP_LCD_SHLR (GPIO_NUM_33)
#else
