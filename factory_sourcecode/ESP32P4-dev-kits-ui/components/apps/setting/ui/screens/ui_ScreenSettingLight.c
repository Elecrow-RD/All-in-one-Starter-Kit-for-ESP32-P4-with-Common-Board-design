...
void ui_ScreenSettingLight_screen_init(void)
{
    ...
    lv_obj_set_x(ui_ButtonScreenSettingLightReturn, -460);
    lv_obj_set_y(ui_ButtonScreenSettingLightReturn, -240);
    ...
    lv_obj_set_style_bg_color(ui_ButtonScreenSettingLightReturn, lv_color_hex(0xF6F6F6), LV_PART_MAIN | LV_STATE_DEFAULT);
