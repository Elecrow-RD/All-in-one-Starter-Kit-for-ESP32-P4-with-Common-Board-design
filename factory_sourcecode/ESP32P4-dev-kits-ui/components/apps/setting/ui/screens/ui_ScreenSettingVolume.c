...
void ui_ScreenSettingVolume_screen_init(void)
{
    ...
    lv_obj_set_x(ui_ButtonScreenSettingVolumeReturn, -460);
    lv_obj_set_y(ui_ButtonScreenSettingVolumeReturn, -240);
    ...
    lv_obj_set_style_bg_color(ui_ButtonScreenSettingVolumeReturn, lv_color_hex(0xF6F6F6), LV_PART_MAIN | LV_STATE_DEFAULT);
