...
void AppSettings::extraUiInit(void)
{
    ...
    lv_obj_add_flag(ui_ButtonScreenSettingLightReturn, LV_OBJ_FLAG_CLICKABLE);
    // Record the screen index and install the screen loaded event callback
    ...
    lv_obj_add_flag(ui_ButtonScreenSettingVolumeReturn, LV_OBJ_FLAG_CLICKABLE);
    // Record the screen index and install the screen loaded event callback
    ...
    lv_obj_add_flag(ui_ButtonScreenSettingAboutReturn, LV_OBJ_FLAG_CLICKABLE);
    // Record the screen index and install the screen loaded event callback
    ...
    lv_label_set_text(ui_LabelPanelPanelScreenSettingAbout5, "v0.1.0");
    lv_label_set_text(ui_LabelPanelPanelScreenSettingAbout2, "All-in-one Starter Kit for ESP32 P4");
    lv_obj_set_x(ui_LabelPanelPanelScreenSettingAbout2, 130);
